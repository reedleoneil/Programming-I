...
void mainscr()
{
	...
	printf("³ Tic Tac Toe Version 2.10                 ³%c  1: New Game  %c³%c  2: Continue  %c³",x[0],x[1],x[2],x[3]);
	...
	while(exiton != 1)
	{
		...
		if(cmd == 1)
		{
			...
			else
			{
				...
				printf("Input Error");
				gotoxy(45,20);
				printf("Edition 1 or 2 only please.");
				gotoxy(45,21);
				printf("Press Any Key...");
				getch();
			}
		...
		if(cmd == 3)
		{
			...
			gotoxy(2,7);
			printf("Tic Tac Toe Version 2.10");
			gotoxy(2,8);
			printf("-Fixed 'continue bug'.");
			gotoxy(2,9);
			printf("-Created new 4 by 4 Edition.");
			gotoxy(2,10);
